@extends('dashboard.index', ['title' => 'Tambah Label'])

@section('content')
    <div class="tab-content">
        <div class="content">
            <div class="flex-column flex-m-row items-center mb-2">
                <h4 class="m-0">Tambah Label Baru</h4>
            </div>
            ...
            @csrf
                ...
                <div class="form-input">
                    ...
                    <input type="text" name="nama_label" id="text_idn" class="input @error('nama_label') invalid @enderror" value="{{ old('nama_label') }}" required>
                </div>
                <!-- Label ENG -->
                <div class="form-input">
                    <label for="text_eng">Nama Label Alternatif</label>
                    <input type="text" name="label_alternatif" id="text_eng" class="input @error('label_alternatif') invalid @enderror" value="{{ old('label_alternatif') }}">
                </div>
                <!-- Button Submit -->
