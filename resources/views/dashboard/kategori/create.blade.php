@extends('dashboard.index', ['title' => 'Tambah Kategori'])

@section('content')
    <div class="tab-content">
        <div class="content">
            <div class="flex-column flex-m-row items-center mb-2">
                <h4 class="m-0">Tambah Kategori Baru</h4>
            </div>
            ...
            @csrf
                ...
                <div class="form-input">
                    ...
                    <input type="text" name="kategori_indonesia" id="text_idn" class="input @error('kategori_indonesia') invalid @enderror" value="{{ old('kategori_indonesia') }}" required>
                </div>
                <!-- Kategori ENG -->
                <div class="form-input">
                    <label for="text_eng">Nama Kategori (English)</label>
                    <input type="text" name="kategori_english" id="text_eng" class="input @error('kategori_english') invalid @enderror" value="{{ old('kategori_english') }}" required>
                </div>
                <!-- Button Submit -->
